...
times = {
        ...
        '750' : [154.3104064464569, 223.40830183029175, 162.83168840408325, 161.83721804618835, 195.2042293548584, 178.376323223114, 164.05835008621216, 210.98963332176208, 235.18934035301208, 185.0239496231079],
        '1000' : [188.4972276687622, 241.1461215019226, 212.54603791236877, 199.13066482543945, 226.39088988304138, 264.34916615486145, 266.89242148399353, 338.04014825820923, 298.0628228187561, 217.11960816383362]
    }
mean_values = [np.mean(times[str(T)]) for T in T_values]

# Least squares polynomial fit
x = np.array([10,10,10,10,10,10,10,10,10,10,250,250,250,250,250,250,250,250,250,250,500,500,500,500,500,500,500,500,500,500,750,750,750,750,750,750,750,750,750,750,1000,1000,1000,1000,1000,1000,1000,1000,1000,1000]).reshape((-1, 1))
y = np.array([2.8322057723999023, 3.7169768810272217, 3.5322799682617188, 3.995462417602539, 3.632303237915039, 5.046312570571899, 4.436202764511108, 4.432348728179932, 4.222238302230835, 4.541436672210693, 49.890037059783936, 47.54969763755798, 48.47557592391968, 45.93554639816284, 51.372334241867065, 64.90720248222351, 48.01697492599487, 45.96428036689758, 44.372485637664795, 44.01561784744263, 129.28476738929749, 122.03907465934753, 104.54554295539856, 116.40743231773376, 153.46324801445007, 131.97159624099731, 97.58699417114258, 101.64296412467957, 100.36379289627075, 75.68742060661316, 154.3104064464569, 223.40830183029175, 162.83168840408325, 161.83721804618835, 195.2042293548584, 178.376323223114, 164.05835008621216, 210.98963332176208, 235.18934035301208, 185.0239496231079, 188.4972276687622, 241.1461215019226, 212.54603791236877, 199.13066482543945, 226.39088988304138, 264.34916615486145, 266.89242148399353, 338.04014825820923, 298.0628228187561, 217.11960816383362])
...
plt.scatter(x,y, s=3, label="Runtimes", color=plt.cm.viridis(0.4)) #, lw=0)
plt.plot(np.array(T_values).reshape((-1, 1)), y_pred, "-", label="Linear regression fit", color=plt.cm.viridis(0.1))
plt.legend()
plt.tight_layout()
