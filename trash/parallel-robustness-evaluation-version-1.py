...
def find_average_rmse_for_one_tuning_strength(lambda_strength):
    ...
    print("######################################")
    return np.mean(X_rmse_values)

print(mp.cpu_count())
pool = mp.Pool(mp.cpu_count())
mean_rmse_values = [pool.apply(find_average_rmse_for_one_tuning_strength, args=[lambda_strength]) for lambda_strength in lambda_strength_array]
pool.close()

np.save("mean_rmse_values-T-" + str(T) + "-parallel", mean_rmse_values)
#np.save("mean_rsquared_values-T-" + str(T) + "-parallel", mean_rsquared_values)
