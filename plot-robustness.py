...
T_array = [500] #[200,500,1000,2000,3000,5000]
...
plt.ylabel("RMSE")
for T_index in range(N_T_values):
    plt.errorbar(x=peak_lambda_array, y=mean_rmse_values_RMSE[T_index], yerr=(2.093*(np.sqrt(sosq_values_RMSE[T_index]/degrees_of_freedom))/np.sqrt(N_seeds)), fmt=".-", label="RMSE choice. T="+str(T_array[T_index]), color = plt.cm.viridis(0.2)) #plt.cm.viridis(T_index/N_T_values*0.8)
    plt.errorbar(x=peak_lambda_array, y=mean_rmse_values_L[T_index], yerr=(2.093*(np.sqrt(sosq_values_L[T_index]/degrees_of_freedom))/np.sqrt(N_seeds)), fmt=".-", label="L choice.        T="+str(T_array[T_index]), color = plt.cm.viridis(0.8))
    plt.errorbar(x=peak_lambda_array, y=mean_rmse_values_3[T_index], yerr=(2.093*(np.sqrt(sosq_values_3[T_index]/degrees_of_freedom))/np.sqrt(N_seeds)), fmt="--", label="Width 3.         T="+str(T_array[T_index]), color = plt.cm.viridis(0.4))
    ...
    plt.errorbar(x=peak_lambda_array, y=mean_rmse_values_10[T_index], yerr=(2.093*(np.sqrt(sosq_values_10[T_index]/degrees_of_freedom))/np.sqrt(N_seeds)), fmt="--", label="Width 10.        T="+str(T_array[T_index]), color = plt.cm.viridis(0.6))
plt.ylim(ymin=0)
plt.xlim(xmin=0)
plt.xticks(range(11))
